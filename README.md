[![Packages](https://img.shields.io/badge/packages-42-blue.svg)](packages)
...
[![Daily run success](https://img.shields.io/badge/pkgs--install--pass-41-green.svg)](https://github.com/mandiant/VM-packages/actions?query=workflow%3Adaily+branch%3Amain)
