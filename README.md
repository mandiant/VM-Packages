...
[![Daily run success](https://img.shields.io/badge/pkgs--install--pass-54-green.svg)](https://github.com/mandiant/VM-packages/actions?query=workflow%3Adaily+branch%3Amain)
