...
try {
  ...
  $zipUrl = 'https://github.com/microsoft/terminal/releases/download/v1.23.12371.0/Microsoft.WindowsTerminal_1.23.12371.0_x64.zip'
  $zipSha256 = 'edad49378e33812947a3fa3aa6ca165f90f1a55f9da04f098773150b115f8596'
