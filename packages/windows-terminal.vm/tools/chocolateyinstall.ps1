...
try {
  ...
  $zipUrl = 'https://github.com/microsoft/terminal/releases/download/v1.22.12111.0/Microsoft.WindowsTerminal_1.22.12111.0_x64.zip'
  $zipSha256 = '551d8a7ae129dae63453b687361a75d925c6b2941342c09aea94bc16f95cc288'
