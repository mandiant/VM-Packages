...
$powershellCommand = 'Import-Module .\MFASweep.ps1; Get-Help Invoke-MFASweep'

VM-Install-Single-Ps1 $toolName $category $ps1Url -ps1Sha256 $ps1Sha256 -powershellCommand $powershellCommand
