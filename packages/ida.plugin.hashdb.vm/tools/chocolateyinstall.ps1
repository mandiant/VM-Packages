...
# Install requirements: https://github.com/OALabs/hashdb-ida/blob/1.11.0/requirements.txt
VM-Pip-Install requests

$pluginName = 'hashdb.py'
$pluginUrl = 'https://github.com/OALabs/hashdb-ida/releases/download/1.11.0/hashdb.py'
