...
$powershellCommand = 'Import-Module AzureAD $PSScriptRoot\AzureAD\MicroBurst-AzureAD.psm1 $PSScriptRoot\Misc\MicroBurst-Misc.psm1 $PSScriptRoot\REST\MicroBurst-AzureREST.psm1'
